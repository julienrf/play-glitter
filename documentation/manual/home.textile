...
This trait defines a @Glitter(content: Xml)@ result type, taking @glitter.Xml@ content as parameter and rendering it as HTML.
...
See the following "sample application":play-glitter-sample.
